...
export default function ComparisonSection() {
  const { comparison_table } = useGlobalDataStore();
    ...
    >
      <div className="space-y-[32px] md:space-y-[48px]">
        ...
        <Box className="flex  overflow-x-auto justify-center items-center w-full gap-[56px]">
          ...
          <ComparisonTable comparison={comparison_table.comparison} coaching_center={comparison_table.coaching_center} clear_cutoff={comparison_table.clear_cutoff} />
        </Box>
      </div>
    </div>
  );
